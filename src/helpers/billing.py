...
def create_price(currency="usd", unit_amount=99.99, 
                 interval= "month", product=None, 
                 metadata={}, raw=False
                ):
    if product is None:
        return None
    print(currency, unit_amount, interval, product, metadata)
...
def start_checkout_session(customer_id, success_url="", 
                           cancel_url="", price_stripe_id="",
                           raw=True):
